...
const verifyEmailTemolate = fs.readFileSync(path.resolve('src/templates/verify-email.html'), 'utf8')
...
const sendVerifyEmail = (toAddress: string, subject: string, body: string) => {
  ...
  return sesClinet.send(sendEmailCommand)
}

export const sendVerifyRegisterEmail = (
  toAddress: string,
  email_verify_token: string,
  template: string = verifyEmailTemolate
) => {
